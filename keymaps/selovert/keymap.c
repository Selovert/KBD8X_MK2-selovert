...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
  	...
  	MO(3)  , _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          MO(3)  , _______,                  KC_VOLU,          \
    ...
    [2] = LAYOUT( /* Windows features */
  	...
  	_______, KC_AE  , KC_SS  , _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______,                                    \
  	MO(3)  , _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          MO(3)  , _______,                  KC_VOLU,          \
  	_______, _______, _______,                            KC_MPLY,                                     _______, _______, _______, _______,         DSKTP_L, KC_VOLD, DSKTP_R  \
    ),
